...
<head>
  ...
  <link href="{{url('/css/error.css')}}" media="all" rel="stylesheet" type="text/css">
  ...
  <div class="page-container page-contaisner-responsive">
    <div class="row space-top-8 space-8 row-table">
        ...
        <div class="col-5 col-middle text-center">
          <img src="{{url('images/error.gif')}}" width="313" height="428" alt="Girl has dropped her ice cream.">
        </div>
      </div>
    </div>
  </div>
