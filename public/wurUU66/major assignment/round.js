...
var myHTML = "<table>";
myHTML += "<tr><td class = 'heading'>Title:</td><td>" + titleTags[current - 1].childNodes+"</td></tr>";
myHTML += "<tr><td class = 'heading'>Author:</td><td>" + authorTags[current - 1].childNodes + "</td></tr>";
myHTML += "<tr><td class = 'heading'>Length:</td><td>" + lengthTags[current - 1].childNodes + "</td></tr>";
myHTML += "<tr><td class = 'heading'>Year:</td><td>" + yearTags[current - 1].childNodes + "</td></tr>";
myHTML += "<tr><td class = 'heading'>Price:</td><td>" + priceTags[current - 1].childNodes + "</td></tr>";
