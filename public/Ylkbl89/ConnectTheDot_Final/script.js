...
var names = [
    ...
    'satay <img src="images/foodicon_satay.png" alt="satay" style="height:54px;">',
    'pizza <img src="images/foodicon_pizza.png" alt="pizza" style="height:50px;">',
    'nasi goreng <img src="images/foodicon_nasigoreng.png" alt="nasi goreng" style="height:52px;">',
...
function clicked(number){
	...
	if (number > 0) {
		...
		if (previousClicked == true) {
			...
			alert("Missed a dot. Did you forget how to count?");
		}
	...
	if(allClicked){
		alert("YA$$$ All dots are connected — Now you can scroll down!");
