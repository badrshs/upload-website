			...
			if(memory_values[0] === memory_values[1]){
				...
				if(tiles_flipped === memory_array.length){
					if (player1Score > player2Score) {
						swal({   title: "Player 1: #winning",   text: "Let's play again!",   imageUrl: "images/trophy.png" });
						...
						//alert("Player 1: #winning. Let's play again!");   
							...
							swal({   title: "Player 2: #winning",   text: "Let's play again!",   imageUrl: "images/claping-hands.png" });
						...
						swal({   title: "Well look at that. You're both winners.",   text: "Let's play again!",   imageUrl: "images/trophyw.png" });
...
$('#playButton').on('click', function(){
	...
	/////// hide "let's get started" button and "Remember me" header title
