        ...
        var x_arrangeItems = function(){
            ...
            for(var i=0;i<t_items_length;i++){
                if(-1!==t_items_categorized[i].categories.indexOf(t_category)||t_category===t_category_all){
                    ...
                    if(-1!==t_items_categorized[i].categories.indexOf(t_category_previous)||t_category_previous===t_category_all){
                        t_items_categorized[i].item.stop().css({overflow:'hidden'}).animate({
                            opacity: 0,
        ...
        var x_arrangeItemsResponsive = function(){
            ...
            for(var i=0;i<t_items_length;i++){
                if(!(-1===t_items_categorized[i].categories.indexOf(t_category))||t_category===t_category_all){
                    ...
                    t_items_categorized[i].item.stop().css({overflow:'hidden'}).css({
...
$(function(){
	var t_time = 300;
	$(".hover_effect").hover(function(){console.log(0)
		//$(this).stop().animate({opacity:1},{queue:false,duration:t_time,easing:'linear'});
		$(this).find(".image_zoom img").stop().animate({marginTop:40},{queue:false,duration:t_time,easing:'linear'});
		...
		$(this).find(".image_zoom img").stop().animate({marginTop:-90},{queue:false,duration:t_time,easing:'linear'});
...
var load_carousel = function(){
    $('.slide_content').each(function(){
        ...
        var t_pre_process = function(){
            ...
            t_items_container.stop().css({height:'auto'});
        ...
        var t_img_loaded = function(){
            ...
            t_bar.mousedown(function(e_down){
                ...
                t_d.mousemove(function(e_move){
                    ...
                    if(t_bar_moving_allow){
                        ...
                        if(t_bar_left_temp!==t_bar_left_temp_new){
                            ...
                            t_bar.css({left:t_bar_left_temp});
                            t_items_container.css({left:-t_bar_left_temp*t_bar_items_ratio});
                ...
                t_d.mouseup(function(e_up){
                    ...
                    t_bar.animate({left:t_bar_left},{queue:false,duration:t_bar_animate_time,easing:'linear'});
                    t_items_container.animate({left:-t_items_width*t_index},{queue:false,duration:t_bar_animate_time,easing:'linear'});
                ...
                if( t_w_width>=980){
                    if(t_w_x!==0){
                        ...
                        t_pre_process_specific = function(){
                            ...
                            t_bar_left = t_bar_items_width*t_index;
                            t_bar.stop(true).css({left:t_bar_left});
                            t_items_container.stop(true).css({left:-t_items_width*t_index});
                        };
                        t_pre_process();
                    }
                }else
                if( t_w_width>=768){
                    ...
                    if( t_w_x!==2 ){
                        ...
                        t_items_responsive_function = function(){
                            t_items.filter(':eq('+t_index+')').stop().animate({opacity:0},{queue:false,duration:t_items_responsive_time,easing:'linear'});
                            if(t_index<t_index_max)
                                t_index++;
                            else
                                t_index = 0;
                            t_items.filter(':eq('+t_index+')').stop().animate({opacity:1},{queue:false,duration:t_items_responsive_time,easing:'linear'});
                        };
                        ...
                        t_pre_process_specific = function(){
                            ...
                            t_index = 0;
                            if(t_index_max)
                                t_items.filter(':gt('+String(t_visible-1)+')').css({opacity:0});
                            t_items_container.css({height:t_items.filter(':gt('+t_index+')').outerHeight(true)});
