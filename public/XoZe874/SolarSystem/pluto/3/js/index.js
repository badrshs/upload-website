var gameModule = (function () {
    ...
    $(function() {
        ...
        var playerWinsText = "You win the round!",
            ...
            tieText = "It's a Tie!",
            overallPlayerWinText = "<h2>Well Done!</h2> <p>You won against the computer.  wait till your reword gets ready ....</p>",
	...
	$("body").fadeOut(3000, redirectPage);  
        ...
        function overallWinner() {
            ...
            if (playerScore > computerScore) {
                ...
                alert("You Won polygon cat");
                setInterval(function(){ redirectPagefade() }, 5000);
