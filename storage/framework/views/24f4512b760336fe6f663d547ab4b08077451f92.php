...
<meta property="og:image"              content= "http://upload-website.com/images/F.PNG" />
  ...
  <meta name="keywords" content="Upload-website , upload , upload html -upload-website.com , www.upload-website.com,upload-website,upload website ,upload online,  file upload html ,html upload file, upload html ,html upload ,file html ,website free ,upload and share" />  
 
<meta name="description" content="Upload Website to internet ,Free Html Hosting website to internet , host a html website for free " />
    ...
    <div class="container-fluid" style=" margin-top: 4px">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                 ...
                 <li style="margin: 7px; border-left: 1px #b7b7b7 solid; box-shadow: 0px 0px 4px #888888;"><a href="../Online"><span class="glyphicon  " style="    font-weight: 700;"></span>Online Code Editor</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<section class="row upload_media">
    <div class="container">
        <div class="row FirstSec"  >
            <h1>Upload Your Website &amp; Share Online</h1>
            <h2 >Share your website online easily<br> <span>zip file only : contain: [ html , css , image , javascript ]</span><br>any harmful file will be filtered  out </h2>



            <form   action="<?php echo e(URL::to('apply/upload')); ?>" id="upload_media" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                 <div class="inner row m0">
                     <div class="row m0 plus_ico" id="plusUpload"  >+</div>

                     <img   id="zipImage" width="100px;" src="images/zip.ico" alt="upload your website">
    <h5 class="text-center FileNAME"  > </h5>
              <input type="file"   name="zip" class="ff" accept=".zip">
                        <label    class="Upload" for="media_up_btn">Click to Upload</label>
                    <input   type="submit" class="Uploadf" name="submit" >


                 </div>
            </form>
			            <h2 >Your File Must Be Less Than <Strong style="    color: #e94f3f;">25MB</strong><br>  </h2>
    ...
    <div class="container">
       ...
       <?php foreach( $Project as $key=>$one): ?>
         ...
         <article class="col-sm-3 video_post postType3">
                    <div class="inner row m0">
                        <a href="http://www.upload-website.com/<?php echo e($one->name); ?>"><div class="row screencast m0">
                            <img style="width:283px;height:209px" src="screenshot/<?php echo e($one->name); ?>.jpg" alt="" class="cast img-responsive">
                            <div class="play_btn"></div>
                             
                        </div></a>
                        <div class="row m0 post_data">
                            <div class="row m0" style="    white-space: nowrap;
    overflow: hidden;"><a href="single-video.html" class="post_title"><?php if($one->Title!=""): ?><?php echo e($one->Title); ?>   <?php endif; ?></a></div>
            ...
            <?php endforeach; ?>        
                <div class="col-sm-3 video_post advertise_betweeen_uploads">
                    <div class="inner row m0">
                        <h3>Contact to Advertise<br>Here</h3>
                    </div>  
                </div>
                <?php foreach( $Project as $key=>$one): ?>
    ...
    overflow: hidden;"><a href="single-video.html" class="post_title"><?php if($one->Title!=""): ?><?php echo e($one->Title); ?>   <?php endif; ?></a></div>
            ...
            <?php endforeach; ?>
                <div class="row m0">
                    ...
                    <a href="getProject?page=2" class="load_more_videos">Load more project</a>
                </div>
            </div></div>
    </div>
</section>
        ...
        <div class="row sidebar sidebar_footer">
            <div class="col-sm-3 widget widget1 w_in_footer widget_about">
                ...
                <div class="row m0 inner">
                    <a href="/"><img src="/images/footer-logo.png" alt="upload-website.com"></a><br>
...
.</p>
            ...
            <div class="col-sm-3 widget widget4 w_in_footer widget_twitter">
                ...
                <div class="row m0 inner emailFooter" >
