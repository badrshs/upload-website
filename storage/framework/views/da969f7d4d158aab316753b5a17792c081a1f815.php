    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if($show): ?>
                    <li style="cursor: pointer;border-left: 2px solid rgba(34, 34, 34, 0.53);"><a href="../Live/<?php echo e($id); ?>"
                                                                                                  target="_blank"><span
...
<script >
    ...
    <?php if($show): ?>
     $(window).ready(function(){
       ...
       <?php endif; ?>
    var iframe ="<iframe  <?php if($show): ?> src='Live/<?php echo e($id); ?>'  <?php endif; ?> id='abc_frame'  style='background: whitesmoke; border: 0;  width: 100%;  height: 100%; top: 0;  left: 0;  z-index: 1;display:none' ></iframe>";
    var editorHtml = null;
    var editorCss = null;
    var editorJs = null;
</script>
